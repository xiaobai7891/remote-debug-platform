  ...
  <div class="auth-container">
    ...
    <div class="auth-card">
      ...
      <div class="auth-header">
        ...
        <h1 class="auth-title">
          <span class="title-text">REMOTE</span>
          <span class="title-accent">DEBUG</span>
        </h1>
        <p class="auth-subtitle">// 远程调试控制台</p>
      </div>
      ...
      <el-form ref="formRef" :model="form" :rules="rules" @submit.prevent="handleLogin" class="auth-form">
        ...
        <el-button
          ...
          class="submit-btn"
        >
          <span class="btn-text">{{ loading ? '正在连接...' : '建立连接' }}</span>
        ...
        <div class="auth-links">
          ...
          <router-link to="/register" class="link-action">
            创建账号 <el-icon><ArrowRight /></el-icon>
          </router-link>
        </div>
      </el-form>
...
import { User, Lock, Right, ArrowRight } from '@element-plus/icons-vue'
...
.auth-form :deep(.el-input__wrapper.is-focus) {
  border-color: var(--neon-cyan);
  box-shadow: 0 0 0 3px rgba(0, 240, 255, 0.1), inset 0 0 20px rgba(0, 240, 255, 0.05);
}
